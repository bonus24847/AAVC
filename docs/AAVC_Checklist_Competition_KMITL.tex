...
\item \who{OP} \textbf{แบต}: เกจ voltage-only อ่าน conservative · floor: egress 30\% (กลับทาง corridor ปกติ) · RTH 15\% / LAND 10\% (failsafe) · energy gate ปฏิเสธไม่เริ่มถ้าไม่พอ
...
\begin{cl}
\item \textbf{Slot 1 — ภารกิจเต็มบนสนามจริง}: profile competition · เก็บ: sweep 20 m เห็นแผ่นขาวครบทุกใบไหม (candidate) · decode-visit ที่ 10.5 m อ่าน id ได้ไหม (\code{target_confirmed}) · corridor ใหม่ P2$'$/P3$'$ ผ่าน 3/3 · AGL นิ่ง · เวลา sweep จริง vs 247 s
